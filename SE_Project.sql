...
CREATE TABLE USERDETAILS( USER_ID INT PRIMARY KEY, FAV_CUISINE TEXT, SPICINESS TEXT, FOOD_CHOICE TEXT,ALLERGY TEXT,STATE TEXT, FOREIGN KEY(USER_ID) REFERENCES USER(USER_ID));
